...
document.getElementById('navbar').insertAdjacentHTML('beforeend', '<div class="container"><ul class="nav nav-tabs justify-content-center mx-0 my-2">' +
  '<li class="nav-item">' +
  '<a class="nav-link mtb px-1" aria-current="page" href="/markalar.html" id="marka-tab">Marka</a>' +
  '</li>' +
  '<li class="nav-item">' +
  '<a class="nav-link mtb px-1" href="/urunler.html"  id="urun-tab">Ürün</a>' +
  '</li>' +
  '<li class="nav-item">' +
  ...
  '</li>' +
  '<li class="nav-item">' +
  '<a class="nav-link mtb" href="/urunler.html"  id="tl-tab">TL</a>' +
  '</li>' +
  '</ul></div>')
